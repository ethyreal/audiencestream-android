...
import com.tealium.audiencestream.testutil.Timeout;
...
public class AudienceDiffNotifierTest extends TestCase {
    ...
    public void testRun() throws Exception {
        ...
        AudienceStream.getEventListeners().add(listener);
    ...
    private static class AudienceListener implements AudienceStream.OnAudienceUpdateListener {
