...
final class Events {
    ...
    static class Event<T> implements Runnable {
        ...
        /**
         * Calls {@link com.tealium.audiencestream.Events.Event#onInvoke(Object)} }.
         *
         * @throws IllegalStateException when {@link com.tealium.audiencestream.Events.Event#setListeners(java.util.Collection)} was never called
