...
public final class Key {
     ...
     * <br/>
     * * "view" when calling {@link AudienceStream#sendView(Map)}.
     * * "link" when calling {@link AudienceStream#sendEvent(Map)}.
     * * First argument when calling {@link AudienceStream#send(String, Map)}.
     */
