...
final class EventBus {
    ...
    static void initialize(AudienceStream.Config config) {
    ...
    /**
     * Generates a {@link com.tealium.audiencestream.Events.OnDisableListener} event and submits it. It then
    ...
    private static Runnable createInitRunnable(final AudienceStream.Config config) {
        return new Runnable() {
            @Override
            public void run() {
